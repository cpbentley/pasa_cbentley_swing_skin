...
/**
 * By convention Tech Strings start with an s.
 * @author Charles Bentley
 *
 */
public interface ITechStringsSwingSkin extends ITech {

   public static final String sAddfavorite    = "lookandfeel.addfavorite";
   ...
   public static final String sFontIncrease   = "lookandfeel.font.increase";

   public static final String sFontDecrease   = "lookandfeel.font.decrease";
}
